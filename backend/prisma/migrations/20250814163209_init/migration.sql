...
-- AddForeignKey
ALTER TABLE `correos_empresa` ADD CONSTRAINT `correos_empresa_empresaContactoId_fkey` FOREIGN KEY (`empresaContactoId`) REFERENCES `empresa_contacto`(`id`) ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE `telefonos_empresa` ADD CONSTRAINT `telefonos_empresa_empresaContactoId_fkey` FOREIGN KEY (`empresaContactoId`) REFERENCES `empresa_contacto`(`id`) ON DELETE RESTRICT ON UPDATE CASCADE;
