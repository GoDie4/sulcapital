...
export const MenuLogeado = () => {
  const { cerrarSesion, authUser } = useAuth();
  return (
    <div className="absolute z-[999] top-full menuProfile  bg-white-main w-52 rounded-main right-0 lg:left-0 shadow--menuProfile p-2 transition-all duration-500 ease-out">
          ...
          (authUser?.rol_id === 1 && (
            <li className="hover:bg-secondary-main/10 px-4 py-2 rounded-main">
              ...
              >
                ...
                <p className="text-black-900">Mis propiedades</p>
              </Link>
            </li>
          ))}
        <li className="hover:bg-secondary-main/10 px-4 py-2 rounded-main">
